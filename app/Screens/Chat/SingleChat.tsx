...
const SingleChat = ({ navigation } : SingleChatScreenProps) => {
    ...
    return (
        <SafeAreaView style={[GlobalStyleSheet.container,{padding:0, backgroundColor: colors.card, flex: 1, }]}>
                            ...
                            return (
                                <View key={index}>
                                    ...
                                    >
                                        ...
                                        >
                                            <Text style={{ ...FONTS.fontSemiBold, fontSize: 13, color: data.send ? COLORS.white :theme.dark ? COLORS.white : COLORS.title, paddingVertical: 10, paddingHorizontal: 10,lineHeight:20 }}>{data.title}</Text>
                                        </View>
                                        {data.time &&
            ...
            >
                <View style={{ height: 75, backgroundColor:theme.dark ? colors.background : colors.card, paddingHorizontal: 15,borderTopWidth:1,borderTopColor:colors.border }}>
                    <View 
                        style={{
                            height: 48,
                            width: '100%', 
