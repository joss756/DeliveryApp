        ...
        return (
            <View style={{
                ...
                <Image
                    ...
                    source={item.icon}
                />
                <Text style={[FONTS.fontMedium, { fontSize: 16, color: colors.title, flex: 1,textTransform:'uppercase' }]}>{item.title}</Text>
                <View
                    style={{
                        width: 24,
                        height: 24,
        ...
        return (
            <View style={{
                ...
                {item.component ?
                    ...
                    item.payment ?
                        <View>
                            <Text style={{ ...FONTS.fontMedium, fontSize: 14, color: colors.title, marginBottom: 5 }}>Link Your Wallet</Text>
                            <CustomInput
                                onChangeText={(value: any) => console.log(value)}
                                placeholder={"+91"}
                        ...
                        item.netbanking ?
                            ...
                            :
                            <Text style={[FONTS.fontMedium, { color: colors.text, lineHeight: 20,fontSize:15 }]}>{item.content}</Text>
                }
            </View>
        )
    }
