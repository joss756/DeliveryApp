...
export const COLORS = {
	primary: "#FFA048", 
	primaryLight: "rgba(255, 160, 72, 0.20)",
	secondary: "#50B0BF",
	success: "#04BB66",
	danger: "#CC0D39",
	warning: "#ffb02c",
...
export const FONTS = {
	fontLg: { fontSize: SIZES.fontLg, color: COLORS.text, lineHeight: 20, fontFamily: 'RobotoCondensedRegular' },
	font: { fontSize: SIZES.font, color: COLORS.text, lineHeight: 20, fontFamily: 'RobotoCondensedRegular' },
	fontSm: { fontSize: SIZES.fontSm, color: COLORS.text, lineHeight: 18, fontFamily: 'RobotoCondensedRegular' },
	fontXs: { fontSize: SIZES.fontXs, color: COLORS.text, lineHeight: 14, fontFamily: 'RobotoCondensedRegular' },
	h1: { fontSize: SIZES.h1, color: COLORS.title, fontFamily: 'RobotoCondensedSemiBold' },
	h2: { fontSize: SIZES.h2, color: COLORS.title, fontFamily: 'RobotoCondensedSemiBold' },
	h3: { fontSize: SIZES.h3, color: COLORS.title, fontFamily: 'RobotoCondensedSemiBold' },
	h4: { fontSize: SIZES.h4, color: COLORS.title, fontFamily: 'RobotoCondensedSemiBold' },
	h5: { fontSize: SIZES.h5, color: COLORS.title, fontFamily: 'RobotoCondensedSemiBold' },
	h6: { fontSize: SIZES.h6, color: COLORS.title, fontFamily: 'RobotoCondensedSemiBold' },
	fontBold: { fontFamily: 'RobotoCondensedBold' },
	fontMedium: { fontFamily: 'RobotoCondensedMedium' },
	fontTitle: { fontFamily: 'RobotoCondensedMedium' },
	fontRegular: { fontFamily: 'RobotoCondensedRegular' },
	fontSemiBold: { fontFamily: 'RobotoCondensedSemiBold' },
	fontLight: { fontFamily: 'RobotoCondensedLight' },
	fontExtraBold: { fontFamily: 'RobotoCondensedExtraBold' },
	DKDisplayPatrol: { fontFamily: 'DKDisplayPatrol' },
	AntonSCRegular: { fontFamily: 'AntonSCRegular' },
}
